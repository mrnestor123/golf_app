...
export { searchUsers, signInEmail, signInWithGoogle, signInWithIOS, signUpEmail, signOut, getSession, createSession, createUser, getUser, updateUser };
...
async function signInWithIOS(provider) {
    const { data, error } = await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: {
...
async function createSession(access_token, refresh_token) {
