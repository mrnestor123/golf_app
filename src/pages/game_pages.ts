            ...
            m(ButtonModal, {
              ...
              modal: game?.round?.tees?.map((tee:Tee)=>{
                ...
                if(course_ratings){
                  ...
                  let crParts = []
                  if(menCR && menCR!='---') crParts.push('M ' + menCR.split('/')[0])
                  if(womenCR && womenCR!='---') crParts.push('W ' + womenCR.split('/')[0])

                  if(crParts.length) descriptionText += 'CR ' + crParts.join(' ')
                }
                ...
                if(slopes){
                  ...
                  let slParts = []
                  if(menSlope && menSlope != '---') slParts.push('M ' + menSlope.split('/')[0])
                  if(womenSlope && womenSlope != '---') slParts.push('W ' + womenSlope.split('/')[0])

                  if(slParts.length) descriptionText += (descriptionText ? ' // ' : '') + 'SL ' + slParts.join(' ')
                }
